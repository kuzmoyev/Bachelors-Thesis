...
\section{SP1 and SP2 subjects}
The work on the ElateMe project started within the framework of the SP1~subject. Our development team devided into
groups: Android, iOS and Back-end developers. Our task was to define and document main client's
requirements, implement functioning prototypes of mobile applications and back-end server \ac{API}. During SP1~subject,
Maksym Balatsko was working on prototype of back-end server, so choise of used technologies was up to him. Chosen
...
documentation has undergone certain changes. And at the start of SP2~subject implementation of back-end API,

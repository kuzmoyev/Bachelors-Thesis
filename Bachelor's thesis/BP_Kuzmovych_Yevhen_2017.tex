...
like Kickstarter or Patreon that help bring \mbox{creative}, commercial projects to life by means of interested people,
ElateMe focuses on the fulfillment of personal wishes with the help of user’s friends. In ElateMe application, the user
can share his wish, and his friends can help him by contributing financially. The development of this platform is a team
...
such as \mbox{the Facebook} Graph API, the interfaces of the online payment systems like FIO-banka and Bitcoin,
the operating system push notification services of Apple(APNs) and Google(GCM). In the framework of this work,
the database structure and server-side application architecture were designed, and the backend interface for
communication with mobile and web applications was implemented \mbox{using} modern web development tools such as Python
programming language, Django web framework, and PostgreSQL DBMS. After that, the application has undergone unit and
performance testing.}

\abstractCS{ElateMe je nová crowdfundingová platforma s elementy sociální sítě. Na rozdíl od jiných podobných projektů,
jako jsou Kickstarter nebo Patreon, které podporují vývoj kreativních a komerčních projektů prostřednictvím zájemců,
\mbox{ElateMe} je zaměřen na naplnění osobních přání s pomocí přátel uživatelů. V aplikaci \mbox{ElateMe} může uživatel
sdílet své přání a jeho přátelé mu mohou pomoci tím, že finančně přispějí. Vývoj této platformy je týmovým projektem.
Práce je rozdělena do vývoje Android a iOS aplikací, backend REST API a reklamního serveru.

Tato bakalářská práce se zaměřuje na vývoj backend REST API pro výše uvedený projekt. Cílem této práce bylo definovat a
...
\dirtree{%
    ...
    .1 src\DTcomment{the directory of source codes}.
        .2 server\_api\DTcomment{implementation sources}.
        .2 thesis\DTcomment{the directory of \LaTeX{} source codes of the thesis}.
    .1 text\DTcomment{the thesis text directory}.
        .2 BP\_Kuzmovych\_Yevhen\_2017.pdf\DTcomment{the thesis text in PDF format}.
        .2 Assignment.pdf\DTcomment{the thesis assignment}.
    .1 documentation\DTcomment{the generated documentation of the analysis}.
        .2 Class model.pdf\DTcomment{class model documentation}.
        .2 Database model.pdf\DTcomment{database model documentation}.
        .2 Requirements.pdf\DTcomment{requirements documentation}.
        .2 Use cases.pdf\DTcomment{use cases documentation}.
        .2 Component diagram.pdf\DTcomment{component diagram documentation}.
        .2 Deployment model.pdf\DTcomment{deployment model documentation}.
}

\chapter{Database model} \label{ch:db_model}
\image[1.1]{db_model/db_packages}{pdf}{Database packages}
\image[1.1]{db_model/account_models}{pdf}{Account models}
\image[1.1]{db_model/donation_models}{pdf}{Donation models}
\image[1.1]{db_model/friendship_models}{pdf}{Friendship models}
\image[1.1]{db_model/wish_models}{pdf}{Wish models}

\chapter{Installation guide} \label{ch:installation_guide}
\input{tex/installation_guide}
